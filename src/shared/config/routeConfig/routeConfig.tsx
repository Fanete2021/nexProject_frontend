...
export enum AppRoutes {
  ...
  ORGANIZATION_TEAM_DETAILS = 'organizationTeamDetails',
  CALENDAR = 'calendar',
  DOCS  = 'docs',
...
export const RoutePath: Record<AppRoutes, string> = {
  ...
  [AppRoutes.ORGANIZATION_TEAM_DETAILS]: `/${AppRoutes.ORGANIZATION}/:orgId/:teamId`,
...
export const routeConfig: Record<AppRoutes, AppRoutesProps> = {
  ...
  [AppRoutes.ORGANIZATION_TEAM_DETAILS]: {
    path: `${RoutePath.organizationTeamDetails}`,
    element: <OrganizationPage />,
    authOnly: true,
  },
  [AppRoutes.CALENDAR]: {
